...
import com.numicago.guiahollywood.dateslider.SliderContainer.OnTimeChangeListener;
...
//        Log.d("M CONTAINER!!!!!!", mContainer.toString());
        ...
        Button todayButton = (Button) findViewById(R.id.dialog_button_today);
    ...
    private android.view.View.OnClickListener todayButtonClickListener = new android.view.View.OnClickListener() {
    	public void onClick(View v) {
    		...
    		if (today.getHourOfDay() >= 0 && today.getHourOfDay() < 6) {
    			today.addDays(-1);
    		}
    		mContainer.setTime(today);
    	}
    };
    ...
    protected void setTitle() {
        if (mTitleText != null) {
            ...
            mTitleText.setText(getContext().getString(R.string.dateSliderTitle) + String.format(": %te/%tB/%tY", c, c, c));
        }
    }
