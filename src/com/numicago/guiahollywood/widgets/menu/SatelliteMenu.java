package com.numicago.guiahollywood.widgets.menu;
...
public class SatelliteMenu extends FrameLayout {
	...
	private void init(Context context, AttributeSet attrs, int defStyle) {
		...
		if(attrs != null){			
			...
			closeOnClick = typedArray.getBoolean(R.styleable.SatelliteMenu_closeOnClick, DEFAULT_CLOSE_ON_CLICK);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int totalHeight = mainImage.getHeight() + satelliteDistance + measureDiff;
		int totalWidth = mainImage.getWidth() + satelliteDistance + measureDiff;
	...
	public void setMainImage(int resource) {
		this.mainImage.setImageResource(resource);
	}
	...
	public void setCloseItemsOnClick(boolean closeItemsOnClick) {
		this.closeOnClick = closeItemsOnClick;
	}
	...
	protected Parcelable onSaveInstanceState() {
		...
		ss.closeItemsOnClick = closeOnClick;
		return ss;
	}
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		closeOnClick = ss.closeItemsOnClick;
